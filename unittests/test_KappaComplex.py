...
class TestKappaComplex(unittest.TestCase):
    ...
    def test_traverse_from(self):
        ...
        kq = KappaComplex('B(a[.] c[1]), C(b[1])')
        nm_1 = NetMap()
        nm_1._edge_map.add((1, 1))
        nm_1._node_map.add((0, 6))
        nm_1._node_map.add((1, 17))
        self.assertEqual(nm_1, _traverse_from(kq.to_networkx(), kc_a.to_networkx(), 0, 6))
        nm_2 = NetMap()
        nm_2._edge_map.add((1, 1))
        nm_2._node_map.add((0, 60))
        nm_2._node_map.add((1, 17))
        ...
        nm_3 = NetMap()
        nm_3._edge_map.add((1, 1))
        nm_3._edge_map.add((0, 2))
        nm_3._node_map.add((0, 7))
        nm_3._node_map.add((1, 8))
        nm_3._node_map.add((2, 6))
        self.assertEqual(nm_3, _traverse_from(pattern_lin.to_networkx(), polymer_4.to_networkx(), 0, 7))
        self.assertEqual([], _traverse_from(pattern_cyc.to_networkx(), polymer_4.to_networkx(), 0, 5))
        self.assertEqual([], _traverse_from(pattern_cyc.to_networkx(), polymer_4.to_networkx(), 0, 7))
        self.assertEqual([], _traverse_from(pattern_cyc.to_networkx(), polymer_4.to_networkx(), 1, 6))
        self.assertEqual([], _traverse_from(pattern_cyc.to_networkx(), polymer_4.to_networkx(), 1, 8))
        self.assertEqual([], _traverse_from(pattern_cyc.to_networkx(), polymer_5.to_networkx(), 0, 12))
        self.assertEqual([], _traverse_from(pattern_cyc.to_networkx(), polymer_5.to_networkx(), 1, 11))
