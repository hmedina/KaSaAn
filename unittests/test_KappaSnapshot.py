...
class TestKappaSnapshot(unittest.TestCase):
    ...
    def test_to_cytoscape_cx(self, ref_snap_kte=snap_kte):
        ref_structure = [{"metaData": [{"name": "nodes", "version": "1.0"},
                             ...
                             "networkAttributes": [{"n": "name", "v": "kite_snap.ka"}, {"n": "time", "v": 1.0},
                                                   {"n": "event", "v": 1}, {"n": "UUID", "v": "000000000"}]}, {
                             "nodes": [{"@id": 0, "n": "A"}, {"@id": 1, "n": "A"}, {"@id": 2, "n": "A"},
                                       {"@id": 3, "n": "A"}, {"@id": 4, "n": "B"}, {"@id": 5, "n": "B"},
                                       {"@id": 6, "n": "C"}, {"@id": 7, "n": "A"}, {"@id": 8, "n": "A"},
                                       {"@id": 9, "n": "A"}, {"@id": 10, "n": "A"}, {"@id": 11, "n": "B"},
                                       {"@id": 12, "n": "B"}, {"@id": 13, "n": "A"}, {"@id": 14, "n": "A"},
                                       {"@id": 15, "n": "A"}, {"@id": 16, "n": "A"}, {"@id": 17, "n": "B"},
                                       {"@id": 18, "n": "B"}]}, {
                             "edges": [{"s": 0, "t": 1, "@id": 19}, {"s": 0, "t": 3, "@id": 20},
                                       {"s": 1, "t": 2, "@id": 21}, {"s": 2, "t": 3, "@id": 22},
                                       {"s": 2, "t": 4, "@id": 23}, {"s": 4, "t": 5, "@id": 24},
                                       {"s": 5, "t": 6, "@id": 25}, {"s": 7, "t": 8, "@id": 26},
                                       {"s": 7, "t": 10, "@id": 27}, {"s": 8, "t": 9, "@id": 28},
                                       {"s": 9, "t": 10, "@id": 29}, {"s": 9, "t": 12, "@id": 30},
                                       {"s": 11, "t": 12, "@id": 31}, {"s": 13, "t": 14, "@id": 32},
                                       {"s": 13, "t": 16, "@id": 33}, {"s": 14, "t": 15, "@id": 34},
                                       {"s": 15, "t": 16, "@id": 35}, {"s": 15, "t": 18, "@id": 36},
                                       {"s": 17, "t": 18, "@id": 37}]}, {
                             ...
                             "edgeAttributes": [{"po": 19, "n": "s_agent_type", "v": "A"},
        ...
        self.assertEqual(ref_snap_kte.to_cytoscape_cx(), ref_structure)
